...
namespace FlowerShop.Controllers
{
    public class FlowersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FlowerID,FlowerName,Price")] Flower flower)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FlowerID,FlowerName,Price")] Flower flower)
        {
            if (ModelState.IsValid)
            {
